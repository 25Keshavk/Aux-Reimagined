...
async function getHostKey(roomId) {
    const redis = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRedis"])();
...
async function removeTrack(roomId, trackId, hostKey) {
...
"[project]/app/api/rooms/[roomId]/vote/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, ctx) {
    ...
    if (!clientId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Missing x-client-id"
    }, {
        status: 400
    });
    const rl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ratelimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimit"])(`aux:rl:vote:${idRoom}:${clientId}`, 200, 60);
    if (!rl.ok) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Rate limited"
    }, {
        status: 429
    });
    ...
    if (!trackId || delta !== 1 && delta !== -1) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Need trackId and delta=1|-1"
        }, {
            status: 400
        });
    }
    try {
        const room = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rooms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["vote"])(idRoom, trackId, delta, clientId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7da97faf._.js.map