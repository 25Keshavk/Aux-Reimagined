...
"[project]/app/api/rooms/[roomId]/events/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, ctx) {
    ...
    const hk = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rooms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getHostKey"])(idRoom);
    const isHost = !!cookieVal && !!hk && cookieVal === hk;
    const stream = new ReadableStream({
        async start (controller) {
            controller.enqueue(encoder.encode("retry: 1000\n\n"));
            const tick = async ()=>{
                const room = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rooms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRoom"])(idRoom);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ba752df1._.js.map